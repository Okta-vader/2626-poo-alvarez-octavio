...
- json.JSONDecodeError: si el archivo contiene JSON inválido, se anuncia y se inicia con vacío.
...
Autor: (poner nombre del estudiante antes de entregar al repositorio)
