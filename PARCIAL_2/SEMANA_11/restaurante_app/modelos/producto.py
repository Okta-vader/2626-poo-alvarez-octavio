...
class Producto:
    ...
    def actualizar(self, nombre: str | None = None, categoria: str | None = None, precio: float | None = None, stock: int | None = None) -> None:
    ...
    def vender(self, cantidad: int) -> None:
        ...
        if cantidad_val <= 0:
            raise ValueError("Cantidad a vender debe ser mayor que cero")
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "Producto":
        ...
        return cls(codigo=codigo, nombre=nombre, categoria=categoria, precio=precio, stock=stock)

    def __repr__(self) -> str:
        return f"Producto(codigo={self.codigo!r}, nombre={self.nombre!r}, categoria={self.categoria!r}, precio={self.precio!r}, stock={self.stock!r})"
